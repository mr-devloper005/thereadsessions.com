...
const inputClass = 'h-12 rounded-2xl border border-[var(--editable-border)] bg-white/85 px-4 text-base font-bold text-slate-950 outline-none transition placeholder:text-slate-500 focus:border-current focus:bg-white'
